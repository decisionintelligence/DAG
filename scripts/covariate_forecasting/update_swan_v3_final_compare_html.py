...
CANDIDATE_MODELS = ["SWAN_V3", "SWAN_V3_TUNE", "SWAN_V3_TUNE_R2", "SWAN_V3_TUNE_R3", "SWAN_V3_TUNE_R4", "SWAN_V3_TUNE_R5"]
...
def scan_best_candidate_records():
    ...
    for dataset_dir in sorted(RESULT_DIR.iterdir()):
        ...
        for model in CANDIDATE_MODELS:
            ...
            if model in {"SWAN_V3_TUNE_R2", "SWAN_V3_TUNE_R3", "SWAN_V3_TUNE_R4", "SWAN_V3_TUNE_R5"}:
...
<body>
  ...
  <div class="note">当前最优结果来源：SWAN_V3 / SWAN_V3_TUNE / SWAN_V3_TUNE_R2 / SWAN_V3_TUNE_R3 / SWAN_V3_TUNE_R4 / SWAN_V3_TUNE_R5 中每个 dataset-horizon 的最小 mse_norm；最后一列为 SWAN_V3_FINAL.sh 对应参数配置。</div>
