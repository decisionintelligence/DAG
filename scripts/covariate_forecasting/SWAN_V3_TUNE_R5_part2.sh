...
echo "=== SWAN_V3 TUNE R5 part2 started ==="
...
# ======================================================
# R5-2: Electricity-192 (当前gap约0.0108)
...
GROUP_WARMUP=800
run_case "Electricity.csv" 192 96 "Electricity/SWAN_V3_TUNE_R5/Electricity_h192_A" 0.5 16 512 256 0.0 1 0.00002 "type3" 4 24 24
...
GROUP_WARMUP=700
run_case "Electricity.csv" 192 96 "Electricity/SWAN_V3_TUNE_R5/Electricity_h192_B" 0.5 16 512 256 0.0 1 0.000025 "type3" 4 24 24
...
GROUP_DYNAMIC_SPARSE=true
GROUP_WARMUP=900
run_case "Electricity.csv" 192 96 "Electricity/SWAN_V3_TUNE_R5/Electricity_h192_C" 0.5 16 512 256 0.0 1 0.000015 "type3" 4 24 24

echo "=== SWAN_V3 TUNE R5 part2 finished ==="
