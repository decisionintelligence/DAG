...
python ./scripts/plot_forecast_from_logs.py --result-dir "./result/maize_NL_NL11_daily_otb_targets_only/SWAN_V3_FINAL" --out-dir "./result/maize_NL_NL11_daily_otb_targets_only/SWAN_V3_FINAL/plots"
