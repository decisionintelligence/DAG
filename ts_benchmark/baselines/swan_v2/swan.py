...
from ts_benchmark.baselines.swan_v2.models.swan_model import SWANV2Model
...
class SWANV2(DeepForecastingModelBase):
    def __init__(self, **kwargs):
        super(SWANV2, self).__init__(MODEL_HYPER_PARAMS, **kwargs)
    ...
    def _init_model(self):
        return SWANV2Model(self.config)
